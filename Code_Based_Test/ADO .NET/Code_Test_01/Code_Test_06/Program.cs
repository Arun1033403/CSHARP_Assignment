...
namespace CodeBasedTest6
{
    ...
    class Program
    {
        ...
        {
            string connectionString = "Server=ICS-LT-JGLJ8G3;Database=Code_Base_Test_02;Trusted_Connection=True;";
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("Add_Employeeese", connection))
                {
